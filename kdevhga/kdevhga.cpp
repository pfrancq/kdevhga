...
KDevHGAApp::KDevHGAApp():KMainWindow(0,"KDevHGA")
{
  config=kapp->config();
...
KDevHGAApp::~KDevHGAApp()
{
  delete printer;
}

void KDevHGAApp::initActions()
{
...
{
  KDevHGAView* w = new KDevHGAView(doc, pWorkspace,0,WDestructiveClose);
...
void KDevHGAApp::slotFileSaveAs()
{
...
void KDevHGAApp::slotViewToolBar()
{
...
void KDevHGAApp::slotViewStatusBar()
{
...
void KDevHGAApp::slotWindowNewWindow()
{
...
void KDevHGAApp::slotWindowTile(){
  pWorkspace->tile();
}

void KDevHGAApp::slotWindowCascade(){
  pWorkspace->cascade();
}
...
void KDevHGAApp::windowMenuAboutToShow()
{
