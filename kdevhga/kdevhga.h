...
/**
  * The base class for KDevHGA application windows. It sets up the main
  ...
  * display whereby one document can have several views.The MDI child is an instance of KDevHGAView,
  * the document an instance of KDevHGADoc.
...
class KDevHGAApp : public KMainWindow
{
  ...
  public:
    /** construtor of KDevHGAApp, calls all init functions to create the application.
